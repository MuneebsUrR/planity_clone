...
function Carousel() {
  ...
  return (
    <div className='relative flex items-center justify-center overflow-hidden'>
            ...
            <div className='ml-4 flex-col items-center container max-w-md hidden md:block'>
              ...
              <div className='flex flex-row mt-4'>
                <button
                  ...
                  className="w-12 h-12 rounded-full bg-white border-2 border-black flex items-center justify-center cursor-pointer text-md mr-2"
                >
                ...
                <button
                  onClick={nextImage}
                  className="w-12 h-12 rounded-full bg-white border-2 border-black flex items-center justify-center cursor-pointer text-md"
                >
      ...
      <div className='relative flex-shrink-0 left-40'>
        <motion.img
