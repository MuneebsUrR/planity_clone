...
export default function Header() {
    ...
    const drawerContent = (
        <div className="p-4 space-y-4">
            <a href="" className='block text-black'>Coiffeur</a>
            <a href="" className='block text-black'>Barbier</a>
            <a href="" className='block text-black'>Manucure</a>
            <a href="" className='block text-black'>Institut de beauté</a>
    ...
    return (
        <div className={`flex justify-between lg:justify-around items-center p-4 transition-colors duration-300 ${scrolled ? 'bg-white shadow-md text-black' : 'bg-transparent text-white'} sticky top-0 z-50`}>
            ...
            <svg id="nav-item-planity-logo" className={`${scrolled ? 'text-black' : 'text-white'}`} width="140px" viewBox="0 0 140 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className='hidden lg:block font-semibold space-x-6 text-sm'>
                <a href="" className='relative group'>Coiffeur
                ...
                <a href="" className='relative group'>Barbier
                    <div className='absolute left-0 bottom-0 h-0.5 w-full bg-current transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300'></div>
                </a>
                <a href="" className='relative group'>Manucure
                    <div className='absolute left-0 bottom-0 h-0.5 w-full bg-current transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300'></div>
                </a>
                <a href="" className='relative group'>Institut de beauté
                    <div className='absolute left-0 bottom-0 h-0.5 w-full bg-current transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300'></div>
                </a>
            </div>
